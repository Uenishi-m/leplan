...
class TokushimaViewController: UIViewController,UITableViewDelegate,UITableViewDataSource,UINavigationControllerDelegate {
 ...
 private var myTableView:UITableView!
   ...
   func navigationController(_ navigationController:UINavigationController,willShow viewController : UIViewController,animated:Bool){
       if let controller = viewController as? PrefectureViewController{
           ...
           //spots = [[String:Any]]()
           controller.tokushimaChoosenindexpath = choosenindexpath
       }
   }
    ...
    @IBAction func toMap(_ sender: Any) {
        performSegue(withIdentifier: "TokushimatoMap", sender: nil)
            choosenindexpath = [IndexPath]()
            spots = [[String:Any]]()
        }
        
        override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
            if segue.identifier == "TokushimatoMap"{
